      ...
      controller: function ($scope) {
        ...
        function splitFields(object) {
          ...
          _.each($scope.fields, function (field) {
            if (field.multiple) {
              console.log(object, field.path, object[field.path]);
              _.each(object[field.path], function (item, index) {
                var newfield = angular.copy(field);
                newfield.path = field.path + '[' + index + ']';
                newfield.localeKey = item.nimi;
          ...
          console.log($scope.expandedFields);
          $scope.updateContentTip();
        }
