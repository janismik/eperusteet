  ...
  .service('PerusopetusService', function () {
    ...
    this.getOsat = function (tyyppi) {
      ...
      switch(tyyppi) {
        case this.OSAAMINEN:
          return [
            {perusteenOsa: {id: 1, nimi: {fi: 'Ajattelu ja oppimaan oppiminen'}}},
            {perusteenOsa: {id: 2, nimi: {fi: 'Kulttuurinen osaaminen, vuorovaikutus ja ilmaisu'}}},
          ];
          ...
          return [
            {
              ...
              vuosiluokat: [7, 8, 9],
              osaamisenkuvaukset: [
                {osaaminen: 1, teksti: 'Lorem ipsum.'}
              ],
              tekstikappaleet: [
